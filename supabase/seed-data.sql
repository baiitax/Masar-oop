...
-- Step 2: Create demo users in auth.users (this requires Supabase Auth)
-- Note: These users need to be created through Supabase Auth API or Dashboard
-- The SQL below creates the profile entries that will be linked when users sign up

-- Step 3: Insert profiles for demo users (will be linked when they sign up)
-- These auth_user_ids are placeholders - real ones come from Supabase Auth
INSERT INTO public.profiles (id, auth_user_id, full_name, email, phone, job_title, country, status) VALUES
  ('p0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Lukman Kura', 'demo.ceo@masar.local', '+2348141815466', 'CEO & Founder', 'NG', 'active'),
  ('p0000001-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', 'Operations Manager', 'demo.operations@masar.local', '+2348023456789', 'Head of Operations', 'NG', 'active'),
  ('p0000001-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000003', 'Compliance Officer', 'demo.compliance@masar.local', '+2348034567890', 'Chief Compliance Officer', 'NG', 'active'),
  ('p0000001-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000004', 'Finance Manager', 'demo.finance@masar.local', '+2348045678901', 'Trade Finance Manager', 'NG', 'active'),
  ('p0000001-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000005', 'Ahmed Al Rajhi', 'demo.buyer@masar.local', '+966501234567', 'Procurement Director', 'SA', 'active'),
  ('p0000001-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000006', 'Oluwaseun Adebayo', 'demo.exporter@masar.local', '+2348023456789', 'Export Manager', 'NG', 'active'),
  ('p0000001-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000007', 'Inspector SGS', 'demo.inspector@masar.local', '+2348034567890', 'Senior Inspector', 'NG', 'active'),
  ('p0000001-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000008', 'Internal Auditor', 'demo.auditor@masar.local', '+2348045678901', 'Chief Auditor', 'NG', 'active');

-- Step 4: Link demo users to organizations
-- CEO -> MASAR Platform
