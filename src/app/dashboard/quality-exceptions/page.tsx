...
export default function QualityExceptionsPage() {
  ...
  return (
    <DashboardPage 
      title="QualityExceptions" 
      subtitle="MASAR QualityExceptions management — V0 concierge operations."
      breadcrumbs={[{ label: 'QualityExceptions' }]}
    >
      <div style={{ background: 'white', borderRadius: '12px', border: '1px solid ' + s.border, padding: '48px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '18px', fontWeight: 700, color: s.text, marginBottom: '8px' }}>MASAR QualityExceptions</h2>
