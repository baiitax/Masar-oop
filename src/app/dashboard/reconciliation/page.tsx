...
export default function ReconciliationPage() {
  ...
  return (
    <DashboardPage 
      ...
      subtitle="MASAR reconciliation management — V0 concierge operations."
    ...
    >
      <div style={{ background: 'white', borderRadius: '12px', border: '1px solid ' + s.border, padding: '48px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '18px', fontWeight: 700, color: s.text, marginBottom: '8px' }}>MASAR Reconciliation</h2>
