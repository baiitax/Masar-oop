...
export default function PortEventsPage() {
  const s = { navy: '#0B1F3A', gold: '#C9A24A', text: '#142235', textSec: '#667085', border: '#E4E7EC', amber: '#F59E0B' };

  return (
    <DashboardPage 
      title="PortEvents" 
      subtitle="MASAR PortEvents management — V0 concierge operations."
      breadcrumbs={[{ label: 'PortEvents' }]}
    >
      <div style={{ background: 'white', borderRadius: '12px', border: '1px solid ' + s.border, padding: '48px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '18px', fontWeight: 700, color: s.text, marginBottom: '8px' }}>MASAR PortEvents</h2>
